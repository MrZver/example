...
class ShipmentDeliveryBoxHandlerTest extends TestCase
{
    /**
    ...
    /**
     * @var ShipmentDeliveryBoxHandler
     */
    private $handler;
    ...
    public function setUp()
    {
        ...
        $this->command = new ShipmentDeliveryBoxCommand('9806b405-86cd-47c0-8b61-b9d6965935fd', $this->user);
        $this->inputItemList = $this->createMock(InputItemList::class);

        $this->handler = new ShipmentDeliveryBoxHandler(
            $this->entityManager,
    ...
    public function testInvoke()
    {
        ...
        $this->assertInstanceOf(\DateTime::class, $shippingBox->getDeliveredAt());
    }
}
