...
use Boodmo\Sales\Model\Workflow\Order\Handler\KeepProcessingItemHandler;
use Boodmo\User\Entity\User;

class KeepProcessingItemCommand extends AbstractCommand
{
    protected const HANDLER = KeepProcessingItemHandler::class;
    /**
     * @var string
     */
    private $itemId;
